...
function CheckoutPage() {
    _s();
    const { items, totalPrice, increaseQuantity, decreaseQuantity, removeFromCart, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    if (items.length === 0) {
...
_s(CheckoutPage, "EoMYWA46lnzffElWJ2EGvoW5vFE=", false, function() {
    return [
